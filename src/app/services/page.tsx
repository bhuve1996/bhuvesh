...
export default function Services() {
  ...
  const services = [
    ...
    },
    {
      ...
      icon: '⚙️',
      description: 'Scalable server-side applications and APIs for your business needs.',
      features: [
        'RESTful APIs',
        'GraphQL APIs',
        'Database Design',
    ...
    },
    {
      ...
      icon: '💡',
      description: 'Expert guidance on technology decisions, architecture, and development strategies.',
      features: [
    ...
    },
    {
      ...
      icon: '🔧',
      description: 'Ongoing maintenance, updates, and support for your existing applications.',
      features: [
        'Bug Fixes',
        'Security Updates',
  ...
  const process = [
    {
      ...
      duration: '1-2 weeks',
      deliverables: ['Project Scope', 'Technical Specification', 'Timeline & Budget']
    },
    {
      step: 2,
    ...
    },
    {
      ...
      description: 'Thorough testing to ensure your application works perfectly across all devices.',
      duration: '1-2 weeks',
    ...
    },
    {
      ...
      description: 'Deploying your application and ensuring everything runs smoothly.',
      duration: '1 week',
  ...
  const testimonials = [
    {
      ...
      content: 'Bhuvesh delivered an exceptional web application that exceeded our expectations. His attention to detail and technical expertise made all the difference.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'Working with Bhuvesh was a game-changer for our business. He understood our vision and brought it to life with cutting-edge technology.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'The website Bhuvesh built for us has significantly improved our online presence and customer engagement. Highly recommended!',
      rating: 5,
    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="/resume" className="text-gray-300 hover:text-white transition-colors duration-300">Resume</a>
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Comprehensive web development and technology solutions to bring your ideas to life.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 pb-16">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">What I Offer</h2>
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {service.technologies.length > 3 && (
                    <span className="text-gray-400 text-xs">+{service.technologies.length - 3} more</span>
                  )}
                </div>
              </div>
            ))}
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                <div>
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-cyan-400 text-lg">{selectedServiceData.pricing}</p>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 border border-cyan-400/20 rounded-xl p-6">
                    ...
                    <p className="text-cyan-400 text-xl font-bold">{selectedServiceData.timeline}</p>
                  </div>
                  
                  <div className="bg-white/5 border border-cyan-400/20 rounded-xl p-6">
                    <h4 className="text-lg font-semibold text-white mb-3">Investment</h4>
                    <p className="text-cyan-400 text-xl font-bold">{selectedServiceData.pricing}</p>
                  </div>
      ...
      <section className="px-6 pb-16">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">My Development Process</h2>
