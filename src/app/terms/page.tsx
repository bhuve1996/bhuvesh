        ...
        <div className='bg-white/5 backdrop-blur-sm border border-cyan-400/20 rounded-2xl p-8 shadow-2xl'>
          ...
          <div className='prose prose-invert max-w-none'>
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-300 mb-4'>This website provides:</p>
              <ul className='list-disc list-inside text-gray-300 space-y-2'>
                <li>Portfolio showcase and professional information</li>
                <li>Resume builder and template services</li>
                <li>ATS (Applicant Tracking System) checker tools</li>
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-300 mb-4'>
                ...
                matters or any part of the website is strictly prohibited.
              </p>
            </section>
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-300 mb-4'>
                Bhuvesh Singla has not reviewed all of the sites linked to our
            ...
            <section className='mb-8'>
              ...
              <p className='text-gray-300 mb-4'>
                Bhuvesh Singla may revise these terms of service for its website
