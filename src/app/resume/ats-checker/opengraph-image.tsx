...
export const alt = 'ATS Checker - Optimize Your Resume for ATS Systems';
export const size = {
  width: 1200,
  height: 630,
};
      ...
      >
        ...
        >
          ...
          >
            ...
            (ATS) to increase your chances of getting noticed by recruiters
          </p>
        ...
        >
          bhuvesh.com/resume/ats-checker
        </div>
      </div>
    ),
    {
