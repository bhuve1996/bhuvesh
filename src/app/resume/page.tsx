...
export default function Resume() {
  ...
  const experience = [
    ...
    },
    {
      ...
      period: "2020 - 2022",
      type: "Full-time",
      description: "Developed and maintained multiple web applications for clients across various industries. Collaborated with design teams to create user-friendly interfaces.",
      achievements: [
      ...
      technologies: ["React", "Vue.js", "Python", "PostgreSQL", "MongoDB", "Redis"]
    },
    {
      id: 3,
      ...
      period: "2019 - 2020",
      type: "Full-time",
      description: "Specialized in creating interactive and responsive user interfaces. Worked closely with designers to bring creative visions to life.",
      achievements: [
  ...
  const skills = {
    "Frontend": ["React", "Next.js", "Vue.js", "TypeScript", "JavaScript", "HTML5", "CSS3", "Tailwind CSS", "Sass", "Figma"],
    "Backend": ["Node.js", "Python", "Express.js", "Django", "FastAPI", "REST APIs", "GraphQL", "Microservices"],
    "Database": ["PostgreSQL", "MongoDB", "Redis", "MySQL", "Firebase", "Supabase"],
    "Cloud & DevOps": ["AWS", "Google Cloud", "Docker", "Kubernetes", "CI/CD", "Terraform", "Jenkins"],
    "Tools & Others": ["Git", "GitHub", "VS Code", "Webpack", "Vite", "Jest", "Cypress", "Postman"]
  };
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Professional experience, education, and skills in web development and software engineering.
          </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {certifications.map((cert) => (
                  ...
                  >
                    ...
                    <p className="text-gray-300 text-sm mb-4">Credential ID: {cert.credential_id}</p>
