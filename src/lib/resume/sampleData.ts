  ...
  experience: [
    {
      ...
      startDate: '2022',
      endDate: 'Present',
      description: 'Lead development of microservices architecture serving 1M+ users. Mentor junior developers and drive technical decisions.',
      achievements: [
    ...
    },
    {
      ...
      startDate: '2019',
      endDate: '2020',
      description: 'Developed frontend components and integrated with backend APIs.',
      achievements: [
